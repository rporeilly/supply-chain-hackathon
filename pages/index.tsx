import { Title, Text, Button, Autocomplete, Container, SimpleGrid, Space } from '@mantine/core';
        ...
        <Container>
          <Title sx={{ fontSize: 70, fontWeight: 900, letterSpacing: -2 }} align="center" mt={100}>
            <Text inherit variant="gradient" component="span">
              Realtime PO Tracking
            </Text>
          </Title>
          <Title sx={{ fontSize: 20, fontWeight: 300 }} align="center" mt={10}>
            <Text component="div">
              Enter your PO# below to view real time statistics and current status.
            </Text>
            <Space h="md" />
            <Container size={300} padding="md">
              <Autocomplete placeholder="Begin typing your SKU or PO" value={value} data={autoData} onChange={setValue} />
            </Container>
          </Title>
        </Container>
        <Container>
